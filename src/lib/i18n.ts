...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'transactions.unsupportedFormat': 'Unsupported file format',
    'transactions.fileTooLarge': 'File too large (max 5MB)',
    'transactions.jalaliDate': 'Jalali date',
    'transactions.uploading': 'Uploading...',
    ...
    'settings.dateFormatGregorian': 'Gregorian (Miladi)',
    'settings.dateFormatJalali': 'Jalali (Shamsi)',
    ...
    'settings.useToman': 'Use Toman display',
    'settings.useTomanHint': 'Display amounts in Toman (÷ 10) — display only, Rial is used for input',
  ...
  fa: {
    ...
    'transactions.allCategories': 'همه دسته‌بندی‌ها',
    'transactions.newest': 'جدیدترین',
    'transactions.oldest': 'قدیمی‌ترین',
    'transactions.highestAmount': 'بیشترین مبلغ',
    'transactions.lowestAmount': 'کمترین مبلغ',
    ...
    'transactions.unsupportedFormat': 'فرمت فایل پشتیبانی نمی‌شود',
    'transactions.fileTooLarge': 'فایل بیش از حد بزرگ است (حداکثر ۵ مگابایت)',
    'transactions.jalaliDate': 'تاریخ شمسی',
    'transactions.uploading': 'در حال آپلود...',
    'transactions.prev': 'قبلی',
    'transactions.next': 'بعدی',
    'transactions.of': 'از',
    ...
    'settings.dateFormatGregorian': 'میلادی',
    'settings.dateFormatJalali': 'شمسی',
    'settings.defaultCurrency': 'ارز پیش‌فرض نمایش',
    'settings.defaultCurrencyHint': 'ارزش خالص و مبالغ به این ارز تبدیل می‌شوند',
    'settings.useToman': 'استفاده از تومان',
    'settings.useTomanHint': 'نمایش مبالغ به تومان ( تقسیم بر ۱۰ ) — فقط جهت نمایش',
