        ...
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-gray-100 bg-white/80 backdrop-blur-sm px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div ref={menuRef} className="relative">
              ...
              {menuOpen && (
                <div className="absolute right-0 top-full mt-2 w-48 rounded-xl border border-gray-100 bg-white py-1 shadow-lg animate-slide-down">
                  <div className="px-3 py-2 border-b border-gray-100">
                    <p className="text-xs text-gray-500">Signed in as</p>
                    <div className="flex items-center gap-2">
                      <p className="text-sm font-medium text-gray-900 font-mono truncate">{userCode}</p>
                      <button
