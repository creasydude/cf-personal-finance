        ...
        <div>
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 rounded-xl px-4 py-2.5 bg-red-600 text-white font-medium text-sm hover:bg-red-700 transition-colors"
            >
              {t("delete.forever")}
            </button>
          </div>
        ...
        <div>
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 rounded-xl px-4 py-2.5 bg-amber-600 text-white font-medium text-sm hover:bg-amber-700 transition-colors"
            >
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card p-6 border-destructive/20">
        <h3 className="text-sm font-semibold text-red-900 dark:text-red-400 mb-4">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          ...
          <button
            onClick={onDelete}
            className="rounded-xl px-4 py-2.5 border border-red-300 text-red-700 font-medium text-sm hover:bg-red-50 transition-colors"
          >
            {t("settings.deleteAccount")}
          </button>
        </div>
...
function PreferencesSection({
  ...
  const [language, setLanguage] = useState(
    settings.language || localStorage.getItem("language") || "fa",
  );
